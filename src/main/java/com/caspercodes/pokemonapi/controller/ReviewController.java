...
public class ReviewController {
    ...
    public ResponseEntity<ReviewDtoResponse> createReview(@PathVariable(value = "pokemonId") Long pokemonId, @RequestBody ReviewDtoResponse reviewDtoResponse) {
    ...
    public ResponseEntity<ReviewDtoResponse> getReviewsById(@PathVariable(value = "pokemonId") Long pokemonId, @PathVariable(value = "reviewId") Long reviewId) {
    ...
    public ResponseEntity<ReviewDtoResponse> updateReview(@PathVariable(value = "pokemonId") Long pokemonId, @PathVariable(value = "reviewId") Long reviewId, ReviewDtoResponse reviewDtoResponse) {
